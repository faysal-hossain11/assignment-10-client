...
const Header = () => {
    ...
    return (
        <div className=' bg-base-100 shadow-md fixed w-full z-10 '>
                ...
                <div className='flex items-center gap-4'>
                    <div>
                        <label className="swap swap-rotate">
                            <input type="checkbox" className="theme-controller" value="synthwave" onChange={(e) => handleTheme(e.target.checked)} checked={theme === 'dark'} />
                            <svg
